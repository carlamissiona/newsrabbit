...
<link rel="stylesheet" href="{{ asset('css/newsrabbit.css') }}">
	<!-- Fonts -->
	...
	<div class="container">
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				...
				<li><a href="#head" class="active">Yo, What's New</a></li>
				<li><a href="#about">About Newsrabbit</a></li>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">	
				...
				<h1 class="title page-text-centered">Newsrabbit  </h1>
				 	<h3 class="tagline">
					The rabbit hole of news feeds.<br>
				  Search hundreds of topics or news sources and subscribe.
				</h3>			  	<!-- Search bar -->
				 <div class="input-group col-md-6  col-lg-6 col-md-offset-3 col-lg-offset-3 text-center">
						<input type="text" class="form-control search-string" placeholder="Search">
						<div class="input-group-btn">
							<button class="btn btn-default search-news" type="button" target-div="search-list">
...
<script src="{{ asset('js/magister.js') }}"></script>
	<script src="{{ asset('js/newsrabbit.js') }}"></script>
</body>
</html>